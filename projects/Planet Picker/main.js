...
function selectPlanet(planet) {
  ...
  const elDiameterDetail = elPlanet.querySelector('[data-detail="diameter"]')
  animate.fromTo({
    from: +prevPlanet.diameter,
    to: +currentPlanet.diameter
  }, value => {
    elDiameterDetail.innerHTML = Math.round(value);
  })
